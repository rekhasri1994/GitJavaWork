package bootcamp4;
	...
	public class BankMain6 {
		...
		public static void main(String[] args) {
			...
			Bank6 b ;
			b=new SbiBank6(account_no,customer_name,trans_type,balanceamount,trans_amount);
			b.display();
			...
			b = new HdfcBank6(account_no1,customer_name1,trans_type1,balanceamount1,trans_amount1);
		     b.display();
		 ...
		 String account_no2 = sc.next();
			...
			double trans_amount2 = sc.nextDouble();
			 ...
			 b = new Bobbank6(account_no2,customer_name2,trans_type2,balanceamount2,trans_amount2);
			b.display();
